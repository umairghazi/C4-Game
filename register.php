...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
    ...
    <main class="mdl-layout__content">
        <div class="page-content">
            <h3 class="centered-text">Register with username and password</h3>
            <form>
                <div class="form-container">
                    ...
                    <div class="mdl-textfield mdl-js-textfield">
                        <input type="button" name="submitRegister" value="Submit" id="submitRegister"
                               class="mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-button--accent"/>
                    </div>
                </div>
            </form>
            <div class="centered-text" id="alertMessage"></div>
            <p class="centered-text"><a href="login.php">Already a user?</a></p>
        </div>
    </main>
</div>
